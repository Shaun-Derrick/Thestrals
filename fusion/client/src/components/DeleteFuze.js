  ...
  return (
    <div >
      ...
      <Container>
       ...
       <Button floated ='left'  color='red' animated='fade' onClick={() => deleteFuze(fuze._id)} as={Link} to="/update">
                     <Button.Content visible>DELETE </Button.Content>
                     <Button.Content hidden >ARE YOU SURE? </Button.Content>
                   </Button>


                   <Button floated ='right' inverted color='green' animated='fade' as={Link} to='/delete'>
