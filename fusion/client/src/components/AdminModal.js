...
import { Button, Header, Image, Modal, Form, Grid, Message, Segment, Container } from 'semantic-ui-react'
...
function AdminModal() {
  ...
  return (
    <Modal 
      ...
      onOpen={() => setOpen(true)}
      open={open}
      trigger={<Button style={{ margin: 10, backgroundColor: '#ff4500'}}>Admin</Button>}
    >
