...
const GridExampleColumnCount = () => (
  <Grid>
    ...
    <Grid.Row columns={5}>
      ...
      <Grid.Column>
        <p>< a href="https://www.linkedin.com/in/debbie-butt-65040490/" target="_blank">LinkedIn Profile</a></p>
      </Grid.Column>
      <Grid.Column>
        <p><a href="https://www.linkedin.com/in/danny-nguyen-b8306b3a/" target="_blank">LinkedIn Profile</a></p>
      </Grid.Column>
      <Grid.Column>
        <p><a href="https://www.linkedin.com/in/kery-long" target="_blank">LinkedIn Profile</a></p>
      </Grid.Column>
      <Grid.Column>
        <p><a href="https://www.linkedin.com/in/shaun-derrick-11642755/" target="_blank">LinkedIn Profile</a></p>
      </Grid.Column>
      <Grid.Column>
        <p><a href="https://www.linkedin.com/in/sidchopp/" target="_blank">LinkedIn Profile</a></p>
      </Grid.Column>
    </Grid.Row>
  </Grid>
)
